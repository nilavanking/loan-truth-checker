...
import { AlertTriangle, BadgeCheck, Calculator, Check, ChevronDown, FileCheck2, IndianRupee, Printer, Scale, SearchCheck, Share2, ShieldCheck, TrendingDown } from "lucide-react";
...
export default function Home() {
  ...
  return <main>
    ...
    <Tabs defaultValue="calculate" className="workspace">
      <TabsList className="tab-list"><TabsTrigger value="calculate"><Calculator size={16}/>Calculate</TabsTrigger><TabsTrigger value="compare"><Scale size={16}/>Compare</TabsTrigger><TabsTrigger value="audit"><SearchCheck size={16}/>Check quote</TabsTrigger><TabsTrigger value="prepay"><TrendingDown size={16}/>Prepay</TabsTrigger><TabsTrigger value="rules"><FileCheck2 size={16}/>Rules</TabsTrigger></TabsList>
      ...
      <TabsContent value="audit" className="panel">
        <div className="panel-heading"><div><span>03</span><h3>Quotation investigator</h3></div><p>Enter exactly what the lender gives you</p></div>
      ...
      <TabsContent value="prepay" className="panel">
        <div className="panel-heading"><div><span>04</span><h3>Prepayment and closure</h3></div><p>See the real benefit after charges</p></div>
      ...
      <TabsContent value="rules" className="panel">
        <div className="panel-heading"><div><span>05</span><h3>Signing checklist</h3></div><p>Evidence required before disbursement</p></div>
